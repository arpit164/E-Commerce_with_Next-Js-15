...
const getTextStyle = (): React.CSSProperties => {
    ...
    const radius = 35;
    const x = Math.cos(radian) * radius - 23;
...
const WinningItem = ({ product, onClose }: {product: Product, onClose: () => void}) => {
    ...
    return (
        <div className='text-center animate-[slideUp_0.5s_ease-out] max-h-[100%] overflow-x-hidden overflow-scroll'>
            <div
                className={`
                    p-5 rounded-xl bg-white shadow-2xl backdrop-blur-lg bg-opacity-90
                    w-[100%]
                                ...
                                <div className='relative bg-gradient-to-br from-white to-gray-50 p-4 rounded-xl shadow-2xl'>
                                    ...
                                    <div className='relative rounded-lg overflow-hidden border-2 border-yellow-400/50 shadow-[0_0_15px_rgba(234,179,8,0.3)]'>
                                        <Image
                                            ...
                                            className='object-cover transform transition-all duration-500 p-5 group-hover:scale-105'
                                            width={200}
                                            height={200}
                                        />
...
const WheelOfFortune = ({ products, winningIndex }: WheelOfFortuneProps) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className='sm:max-w-[800px] min-w-[300px] sm:min-w-[200px] p-0'>
                <DialogTitle>
                ...
                <div className='flex flex-col items-center justify-center px-8 py-4 gap-4 bg-gray-50'>
                    <div 
                        className={`
                            relative w-[350px] h-[350px] md:w-[450px] md:h-[450px] transition-all duration-1000 ease-in-out transform
